...
func (x *EchoResponse) GetReceivedAt() string {
	if x != nil {
		return x.ReceivedAt
	}
	return ""
...
const file_echo_proto_rawDesc = "" +
	...
	"\x06uptime\x18\x02 \x01(\tR\x06uptime2}\n" +
	"\vEchoService\x123\n" +
	"\x04Echo\x12\x14.echo.v1.EchoRequest\x1a\x15.echo.v1.EchoResponse\x129\n" +
	"\x06Health\x12\x16.echo.v1.HealthRequest\x1a\x17.echo.v1.HealthResponseB<Z:github.com/endgrainlabs/example-stack/go-grpc/proto/echopbb\x06proto3"
...
var file_echo_proto_goTypes = []any{
	...
	(*HealthRequest)(nil),  // 2: echo.v1.HealthRequest
	(*HealthResponse)(nil), // 3: echo.v1.HealthResponse
}
var file_echo_proto_depIdxs = []int32{
	0, // 0: echo.v1.EchoService.Echo:input_type -> echo.v1.EchoRequest
	2, // 1: echo.v1.EchoService.Health:input_type -> echo.v1.HealthRequest
	1, // 2: echo.v1.EchoService.Echo:output_type -> echo.v1.EchoResponse
	3, // 3: echo.v1.EchoService.Health:output_type -> echo.v1.HealthResponse
